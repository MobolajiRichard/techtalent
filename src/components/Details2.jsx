...
const Details2 = () => {
  return (
    <div
      ...
      id="about"
      className="flex px-[6%] flex-col items-center md:flex-row bg-[#F8F9FC] md:items-start mt-32 relative"
    >
      <div className="basis-1/2 flex flex-col items-center md:items-start relative">
        ...
        <img alt='boy' src={image3} className="w-[90%] mt-4" />
      </div>
      <div className="basis-1/2 mt-10 md:pl-10 relative">
        ...
        <div className=" flex items-end w-full">
          <div className="h-[40%] w-[50%] md:w-[40%] bg-white p-[3%] rounded-md mr-4">
            ...
            <p className="font-bold text-sm md:text-base mt-3">
              Experienced Mentors
            </p>
            <p className="text-xs md:text-[12px] text-[#a1a1a1] mt-3">
              High-Defination Video Is Video of Higher Resolutio And Quality
