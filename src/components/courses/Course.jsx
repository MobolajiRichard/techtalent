...
const Course = () => {
  ...
  return (
    <div id="courses" className="flex flex-col items-center font-satoshi bg-[#F8F9FC] overflow-x-clip px-[6%] mt-24 relative">
      ...
      <div className="md:w-[50%] w-[80%] flex items-center justify-around text-xs md:text-base text-[#a1a1a1] mt-8 mb-8">
        <button onClick={() => changeCategory('all')} className={`${category === "all" && "active_button"} hover:text-[#004DB3]`}>
          All Categories
        </button>
        <button onClick={() => changeCategory('des')} className={`${category === "des" && "active_button"} hover:text-[#004DB3]`}>Design</button>
        <button onClick={() => changeCategory('dev')} className={`${category === "dev" && "active_button"} hover:text-[#004DB3]`}>Development</button>
        <button onClick={() => changeCategory('mar')} className={`${category === "mar" && "active_button"} hover:text-[#004DB3]`}>Marketing</button>
      </div>
      <Grid
        direction="row"
