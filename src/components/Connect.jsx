...
const Connect = () => {
  return (
    <div
      id="community"
      className="bg-[#004DB3] flex flex-col items-center text-white font-satoshi py-20 mt-10"
    >
      ...
      <button className="p-4 text-[#004DB3] bg-white rounded-lg font-bold mt-10 ">
        Join Our Community
      </button>
    </div>
  );
